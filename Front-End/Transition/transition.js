...
// === SUA ANIMAÇÃO ORIGINAL (mantida na íntegra) ===
...
// Carrega animação (compatível com bodymovin ou lottie)
var anim = (window.bodymovin || window.lottie).loadAnimation(params);

// Estados para transição de conteúdo
var body = document.body;
var close = document.getElementById('close');
body.classList.add("open");

// Evento ao completar a animação
anim.addEventListener("complete", function () {
  if (anim.playDirection == -1) {
    // Modal fechada → reinicia animação (comportamento original do seu demo)
    anim.setDirection(1);
    anim.play();
    body.classList.remove("completed");
  } else {
    // Modal aberta → dispara transições do conteúdo
    body.classList.add("open");
    body.classList.add("completed");

    // 👉 Redireciona para a Home após 1s
    setTimeout(function () {
...
// Botão de fechar → anima ao contrário e volta para o Login
